...
import { validateFormLogin } from "../validateForm/Form";
...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="flex w-[30%] flex-col justify-center px-6 py-12 lg:px-8 bg-[#1A1918] opacity-[0.9] rounded-lg fixed z-10 top-[15%] left-[35%]">
