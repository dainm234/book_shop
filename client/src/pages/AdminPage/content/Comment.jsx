...
import { getDataComment, getNameBookInComment, getNameUserInComment } from "../service/commentService";
                    ...
                    {dataComment.map((comment, index) => (
                        <tbody key={index}>
                            <tr>
                                ...
                                <td data-label="User" className="text-left">{userNames}</td>
                                <td data-label="Book">{bookNames[index]}</td>
                                <td data-label="Coment">{comment.content}</td>
                                <td data-label="Created" className="lg:w-1 whitespace-nowrap pl-[50px]">
                                    <small className="text-gray-500 dark:text-slate-400">{comment.createdAt}</small>
                                </td>
