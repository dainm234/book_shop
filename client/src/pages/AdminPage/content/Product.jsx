      ...
      {showFormAddBookAdmin && (
        <>
          <div className=" fixed left-[35%] z-[10] top-[0px] " >
            <AddProductForm onAddBookSuccess={handleAddBookSuccess} clickClose={handleHideFormAddBook} categories={listCategory} genres={listGenres} />
          </div>
        </>
      )}
          ...
          <tbody >
            ...
            {dataBook.map((book, index) => (
              <tr className="border-b border-gray-200" key={index}>
                ...
                <td className="text-left px-4 py-2">{book.labelBook}</td>
